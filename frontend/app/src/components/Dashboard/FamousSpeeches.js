...
function FamousSpeeches(props) {
    ...
    const speeches = {
        ...
        Congratulations, I love you, God bless you, I respect you.`, audioPath:"./Assets/Famous Speeches/Denzel Washington.mp3"},
    }
        ...
        <div className="famous-speech-container">
            ...
            {   
                Object.keys(speeches).map((key, index) => ( 
                    <FamousSpeechItem speech = {key} text = {speeches[key].text} audioPath = {speeches[key].audioPath} updateSpeech = {props.updateSpeech} updateAudioPath = {props.updateAudioPath}/>  
                    ))
            }
        </div>  
    );
